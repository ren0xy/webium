...
namespace Webium.Unity
{
    ...
    /// Creates, destroys, and reparents <c>GameObject</c> backing objects
    /// for virtual DOM nodes. Internally casts <c>RenderHandle</c> to
    /// <c>GameObject</c> and <c>parentHandle</c> to <c>Transform</c>.
    /// </summary>
    public class GameObjectBacking : IRenderBackend
    {
        /// <inheritdoc />
