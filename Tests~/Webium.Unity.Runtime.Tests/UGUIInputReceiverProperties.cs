...
{
    /// <summary>
    /// Property-based tests for UGUIInputReceiver hit-test-then-forward logic.
    /// Requires Unity Test Runner (Edit Mode) — cannot run in standard .NET.
    /// Feature: event-round-trip
    /// </summary>
    [TestFixture]
    public class UGUIInputReceiverProperties
    {
        /// <summary>
        ...
        /// <summary>
        /// Property 3: UGUIInputReceiver hit-test-then-forward with no-hit filtering
        ///
        /// Since UGUIInputReceiver.ForwardPointer calls HitTest then conditionally
        ...
        ///
        /// We test this by directly calling UGUIInputEventForwarder.ForwardPointerEvent
        ...
        public void HitTestThenForward_ForwardsOnHit_DropsOnNoHit()
        {
            ...
            Prop.ForAll(
                ...
                (eventType, nodeId, x, y, button, pointerId) =>
                {
                    ...
                    var forwarder = new UGUIInputEventForwarder(bridge, nodeObjects);

                    // Simulate what UGUIInputReceiver.ForwardPointer does:
                    ...
                    {
                        // No-hit: UGUIInputReceiver would NOT call ForwardPointerEvent
