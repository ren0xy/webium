...
namespace Webium.Tests.Unity.Runtime.Layout
{
    ...
    public class ExecuteUpdateLayoutProperties
    {
        ...
        /// UGUILayoutBridge reads them back, the readback values SHALL match.
        ...
        public void Property3_LayoutWriteReadRoundTrip()
        {
            ...
            Prop.ForAll(
                ...
                (x, y, w, h) =>
                {
                    ...
                    // Build dictionary for UGUILayoutBridge from executor's NodeObjects
                    ...
                    try
                    {
                        ...
                        var bridge = new UGUILayoutBridge(canvasRect, dict);
