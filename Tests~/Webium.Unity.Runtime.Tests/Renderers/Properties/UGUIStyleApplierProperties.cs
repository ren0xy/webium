...
{
    /// <summary>
    /// Property-based tests for UGUIStyleApplier.
    /// Validates: Requirements 3.1, 4.1, 4.2
    /// </summary>
    [TestFixture]
    public class UGUIStyleApplierProperties
    {
        /// <summary>
            ...
            Prop.ForAll(
                ...
                opacity =>
                {
                    ...
                    try
                    {
                        ...
                        UGUIStyleApplier.Apply(go, styles);
        ...
        /// For any string s, applying display: s via UGUIStyleApplier should set
